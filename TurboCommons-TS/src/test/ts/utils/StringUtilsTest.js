...
QUnit.module("StringUtilsTest", {
	beforeEach : function(assert) {
		...
		window.StringUtils = org_turbocommons_utils.StringUtils;
	}
});
...
QUnit.test("getLines", function(assert) {
	...
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines(null), []));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines(''), []));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines('          '), []));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines('single line'), ['single line']));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines("line1\nline2\nline3"), ['line1', 'line2', 'line3']));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines("line1\n        \nline2"), ['line1', 'line2']));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines("line1\n\n\n\t\r       \nline2"), ['line1', 'line2']));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines("line1\r\n   \r\nline2"), ['line1', 'line2']));
	assert.ok(utils.ArrayUtils.isEqualTo(StringUtils.getLines("line1\n 1  \nline2"), ['line1', ' 1  ', 'line2']));
