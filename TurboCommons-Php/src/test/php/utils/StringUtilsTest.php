...
class StringUtilsTest extends TestCase {
	...
	/**
	 * testGetPathToElement
	 *
	 * @return void
	 */
	public function testGetPathToElement(){

	    // Test empty values
	    $this->assertSame(StringUtils::getPathToElement(null, 0), '');
	    $this->assertSame(StringUtils::getPathToElement('', 0), '');
	    $this->assertSame(StringUtils::getPathToElement('       ', 0), '');

	    try {
	        StringUtils::getPathElement(StringUtils::getPathToElement([], 0));
	        $this->exceptionMessage = '[] did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }
	    ...
	    // includeElementItself - Root element
	    $this->assertSame(StringUtils::getPathToElement('/', 0), '');
	    $this->assertSame(StringUtils::getPathToElement('///////', 0), '');
	    $this->assertSame(StringUtils::getPathToElement('\\', 0), '');
	    $this->assertSame(StringUtils::getPathToElement('c:/', 0), 'c:');
	    $this->assertSame(StringUtils::getPathToElement('c:\\', 0), 'c:');
	    $this->assertSame(StringUtils::getPathToElement('folder', 0), 'folder');
	    $this->assertSame(StringUtils::getPathToElement('//folder', 0), DIRECTORY_SEPARATOR.'folder');
	    $this->assertSame(StringUtils::getPathToElement('C:\\Program Files\\CCleaner\\CCleaner64.exe', 0), 'C:');
	    $this->assertSame(StringUtils::getPathToElement('\\Files/CCleaner/CCleaner64.exe', 0), DIRECTORY_SEPARATOR.'Files');
	    $this->assertSame(StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 0), DIRECTORY_SEPARATOR.'folder');
	    $this->assertSame(StringUtils::getPathToElement('CCleaner64.exe', 0), 'CCleaner64.exe');
	    $this->assertSame(StringUtils::getPathToElement('\\\\\\CCleaner64.exe', 0), DIRECTORY_SEPARATOR.'CCleaner64.exe');
	    $this->assertSame(StringUtils::getPathToElement('\\some long path containing lots of spaces\\///CCleaner64.exe', 0), DIRECTORY_SEPARATOR.'some long path containing lots of spaces');
	    $this->assertSame(StringUtils::getPathToElement("MultiLine\n\n\r\n   and strange &%·Characters\\CCleaner64.exe", 0), "MultiLine\n\n\r\n   and strange &%·Characters");
	    $this->assertSame(StringUtils::getPathToElement("folder1\\\\folder2//folder3///\\\\folder4", 0), 'folder1');
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es', 0), 'https:');
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es//////', 0), 'https:');

	    // includeElementItself - Last element
	    $this->assertSame(StringUtils::getPathToElement('C:\\Program Files\\CCleaner\\CCleaner64.exe', 3), 'C:'.DIRECTORY_SEPARATOR.'Program Files'.DIRECTORY_SEPARATOR.'CCleaner'.DIRECTORY_SEPARATOR.'CCleaner64.exe');
	    $this->assertSame(StringUtils::getPathToElement('\\Files/CCleaner/CCleaner64.exe', 2), DIRECTORY_SEPARATOR.'Files'.DIRECTORY_SEPARATOR.'CCleaner'.DIRECTORY_SEPARATOR.'CCleaner64.exe');
	    $this->assertSame(StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 3), DIRECTORY_SEPARATOR.'folder'.DIRECTORY_SEPARATOR.'folder2'.DIRECTORY_SEPARATOR.'folder3'.DIRECTORY_SEPARATOR.'file.txt');
	    $this->assertSame(StringUtils::getPathToElement('\\some long path containing lots of spaces\\///CCleaner64.exe', 1), DIRECTORY_SEPARATOR.'some long path containing lots of spaces'.DIRECTORY_SEPARATOR.'CCleaner64.exe');
	    $this->assertSame(StringUtils::getPathToElement("MultiLine\n\n\r\n   and strange &%·Characters\\CCleaner64.exe", 1), "MultiLine\n\n\r\n   and strange &%·Characters".DIRECTORY_SEPARATOR."CCleaner64.exe");
	    $this->assertSame(StringUtils::getPathToElement("folder1\\\\folder2//folder3///\\\\folder4", 3), "folder1".DIRECTORY_SEPARATOR."folder2".DIRECTORY_SEPARATOR."folder3".DIRECTORY_SEPARATOR."folder4");
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es', 1), 'https:'.DIRECTORY_SEPARATOR.'www.google.es');
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es//////', 1), 'https:'.DIRECTORY_SEPARATOR.'www.google.es');

	    // includeElementItself - Intermediate elements
	    $this->assertSame(StringUtils::getPathToElement('C:\\Program Files\\CCleaner\\CCleaner64.exe', 2), 'C:'.DIRECTORY_SEPARATOR.'Program Files'.DIRECTORY_SEPARATOR.'CCleaner');
	    $this->assertSame(StringUtils::getPathToElement('\\Files/CCleaner/CCleaner64.exe', 1), DIRECTORY_SEPARATOR.'Files'.DIRECTORY_SEPARATOR.'CCleaner');
	    $this->assertSame(StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 2), DIRECTORY_SEPARATOR.'folder'.DIRECTORY_SEPARATOR.'folder2'.DIRECTORY_SEPARATOR.'folder3');
	    $this->assertSame(StringUtils::getPathToElement('\\a\\b\\c\\d///\\e\\f\\g//', 4), DIRECTORY_SEPARATOR.'a'.DIRECTORY_SEPARATOR.'b'.DIRECTORY_SEPARATOR.'c'.DIRECTORY_SEPARATOR.'d'.DIRECTORY_SEPARATOR.'e');
	    $this->assertSame(StringUtils::getPathToElement('folder1\\\\folder2//folder3///\\\\folder4', 1), 'folder1'.DIRECTORY_SEPARATOR.'folder2');

	    // NOT includeElementItself - Root element
	    $this->assertSame(StringUtils::getPathToElement('/', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('///////', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('\\', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('c:/', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('c:\\', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('folder', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('//folder', 0, false), DIRECTORY_SEPARATOR);
	    $this->assertSame(StringUtils::getPathToElement('C:\\Program Files\\CCleaner\\CCleaner64.exe', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('\\Files/CCleaner/CCleaner64.exe', 0, false), DIRECTORY_SEPARATOR);
	    $this->assertSame(StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 0, false), DIRECTORY_SEPARATOR);
	    $this->assertSame(StringUtils::getPathToElement('CCleaner64.exe', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('\\\\\\CCleaner64.exe', 0, false), DIRECTORY_SEPARATOR);
	    $this->assertSame(StringUtils::getPathToElement('\\some long path containing lots of spaces\\///CCleaner64.exe', 0, false), DIRECTORY_SEPARATOR);
	    $this->assertSame(StringUtils::getPathToElement("MultiLine\n\n\r\n   and strange &%·Characters\\CCleaner64.exe", 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement("folder1\\\\folder2//folder3///\\\\folder4", 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es', 0, false), '');
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es//////', 0, false), '');


	    // NOT includeElementItself - Last element
	    $this->assertSame(StringUtils::getPathToElement('C:\\Program Files\\CCleaner\\CCleaner64.exe', 3, false), 'C:'.DIRECTORY_SEPARATOR.'Program Files'.DIRECTORY_SEPARATOR.'CCleaner');
	    $this->assertSame(StringUtils::getPathToElement('\\Files/CCleaner/CCleaner64.exe', 2, false), DIRECTORY_SEPARATOR.'Files'.DIRECTORY_SEPARATOR.'CCleaner');
	    $this->assertSame(StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 3, false), DIRECTORY_SEPARATOR.'folder'.DIRECTORY_SEPARATOR.'folder2'.DIRECTORY_SEPARATOR.'folder3');
	    $this->assertSame(StringUtils::getPathToElement('\\some long path containing lots of spaces\\///CCleaner64.exe', 1, false), DIRECTORY_SEPARATOR.'some long path containing lots of spaces');
	    $this->assertSame(StringUtils::getPathToElement("MultiLine\n\n\r\n   and strange &%·Characters\\CCleaner64.exe", 1, false), "MultiLine\n\n\r\n   and strange &%·Characters");
	    $this->assertSame(StringUtils::getPathToElement("folder1\\\\folder2//folder3///\\\\folder4", 3, false), "folder1".DIRECTORY_SEPARATOR."folder2".DIRECTORY_SEPARATOR."folder3");
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es', 1, false), 'https:');
	    $this->assertSame(StringUtils::getPathToElement('https://www.google.es//////', 1, false), 'https:');

	    // NOT includeElementItself - Intermediate elements
	    $this->assertSame(StringUtils::getPathToElement('C:\\Program Files\\CCleaner\\CCleaner64.exe', 2, false), 'C:'.DIRECTORY_SEPARATOR.'Program Files');
	    $this->assertSame(StringUtils::getPathToElement('\\Files/CCleaner/CCleaner64.exe', 1, false), DIRECTORY_SEPARATOR.'Files');
	    $this->assertSame(StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 2, false), DIRECTORY_SEPARATOR.'folder'.DIRECTORY_SEPARATOR.'folder2');
	    $this->assertSame(StringUtils::getPathToElement('\\a\\b\\c\\d///\\e\\f\\g//', 4, false), DIRECTORY_SEPARATOR.'a'.DIRECTORY_SEPARATOR.'b'.DIRECTORY_SEPARATOR.'c'.DIRECTORY_SEPARATOR.'d');
	    $this->assertSame(StringUtils::getPathToElement('folder1\\\\folder2//folder3///\\\\folder4', 1, false), 'folder1');

	    // Test wrong values
	    try {
	        StringUtils::getPathToElement('//folder/folder2/folder3/file.txt');
	        $this->exceptionMessage = 'non provided index did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }

	    try {
	        StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', -1);
	        $this->exceptionMessage = '-1 index did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }

	    try {
	        StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', -5);
	        $this->exceptionMessage = '-5 index did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }

	    try {
	        StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 4);
	        $this->exceptionMessage = '4 index did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }

	    try {
	        StringUtils::getPathToElement('//folder/folder2/folder3/file.txt', 25);
	        $this->exceptionMessage = '25 index did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }
	    ...
	    // Test exceptions
	    try {
	        StringUtils::getPathToElement(['//folder/folder2/folder3/file.txt'], 0);
	        $this->exceptionMessage = 'array did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }
	    ...
	    try {
	        StringUtils::getPathToElement(125, 0);
	        $this->exceptionMessage = '125 did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }
	    ...
	    try {
	        StringUtils::getPathToElement(new stdClass(), 0);
	        $this->exceptionMessage = 'new stdClass() did not cause exception';
	    } catch (Throwable $e) {
	        // We expect an exception to happen
	    }
